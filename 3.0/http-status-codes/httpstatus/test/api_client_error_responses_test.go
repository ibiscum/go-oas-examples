...
func Test_httpstatus_ClientErrorResponsesAPIService(t *testing.T) {
	...
	t.Run("Test ClientErrorResponsesAPIService GetStatus400", func(t *testing.T) {
		...
		httpRes, _ := apiClient.ClientErrorResponsesAPI.GetStatus400(context.Background()).Execute()
	...
	t.Run("Test ClientErrorResponsesAPIService GetStatus401", func(t *testing.T) {
		...
		httpRes, _ := apiClient.ClientErrorResponsesAPI.GetStatus401(context.Background()).Execute()
	...
	t.Run("Test ClientErrorResponsesAPIService GetStatus402", func(t *testing.T) {
		...
		httpRes, _ := apiClient.ClientErrorResponsesAPI.GetStatus402(context.Background()).Execute()

		// require.Nil(t, err)
		assert.Equal(t, 402, httpRes.StatusCode)
